...
このRepositoryは、Next.js / Supabase / Vercelを使ったWebアプリ向けの公開テンプレートです。
...
- 現在の `main` に含まれる共通基盤
- Supabase Auth / Session / Cookie / RLS / GRANTの共通実装
- Publishable Key / Secret Key / Production envの扱い
- PWA / Service Workerの認証済みResponse Cache境界
